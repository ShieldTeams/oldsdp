...
function create_config( )
  -- A simple config with basic plugins and ourselves as privileged user
    ...
    sudo_users = {206596952},
    admins = {},
    disabled_channels = {},
    moderation = {data = './data/moderation.json'},
    info_text = [[》SHIELD POWER BoT 
    
            ♈️ FINAL

    Advanced ManagerBot Based On SDP
=======================
...
✚✚✚✚✚✚✚✚✚✚✚✚✚✚✚✚
    ...
    Developer by SD ™ and other that help me for this Bot

   ⭐ ساخت ربات توسط تیم شیلد و دیگر دوستانی که به ما کمک کردند
